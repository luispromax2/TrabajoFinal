...
public class ClienteController {
	...
	public String star(Model model) {
		...
		try {
			// objeto utilizado para la busqueda
	...
	@PostMapping("/search")
	public String search(@ModelAttribute("cliente") Cliente cliente, Model model) {
		try {

			List<Cliente> clientes = clienteService.fetchByDistrito(cliente.getDistrito());
			model.addAttribute("clientes", clientes);
